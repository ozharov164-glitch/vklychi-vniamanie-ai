...
export const COPY = {
  ...
  modes: {
    ...
    noise: {
      title: 'Шум в голове',
      hint: 'Выложи всё, что крутится в голове — выберём одну опору по главной боли.',
  ...
  thinking: {
    ...
    anchor: 'Собираю опору примерно на минуту',
  ...
  encouragement: 'Ты уже три раза начинал(а) с опоры — в этот раз получится ещё быстрее',
  ...
  result: {
    ...
    closeHint: 'Это не оценка. Запись не попадёт в историю, если отменишь.',
  ...
  premium: {
    title: 'Премиум',
    text: 'Глубже разбор, точнее опоры и больше запросов в день. Оформить — в боте, раздел «Тарифы».',
  },
  ...
  disclaimer:
    'Не является диагностикой СДВГ. Инструмент самопомощи при трудностях с вниманием и с началом задач.',

  measurableAiBadge: 'ИИ подобрал шаг за тебя',
